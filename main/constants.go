...
const (
	...
	// Number of minutes to allow between heartbeat file updates before considering the existing process as unresponsive/stuck.
	// If the heartbeat file hasn't been updated within this interval, a new instance should take over.
	...
	AppHealthHeartbeatFileName = "apphealth-heartbeat.txt"
